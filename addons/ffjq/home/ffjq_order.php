...
<div class="container">';
  ...
  <!-- 电脑端横排列表 -->
  <div class="left-nav">
    <a href="ffjq_order.php?t=home/ffjq_order"><button type="button" class="btn btn-zdy">付费订单</button></a>
    <a href="javascript:;"><button type="button" class="btn btn-zdylight" data-toggle="modal" data-target="#checkbz">查询备注码</button></a>
    <a href="index.php?t=home/index"><button type="button" class="btn btn-zdylight">返回上一页</button></a>
