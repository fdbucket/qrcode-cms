...
<div class="container">';
  ...
  <div class="left-nav">
    ...
    <button type="button" class="btn btn-light"><a href="./index.php">返回首页</a></button>
      ...
      //计算总活码数量
      $sql_huoma = "SELECT * FROM qrcode_qun";
      ...
      // 获取群活码列表
      $sql = "SELECT * FROM qrcode_qun ORDER BY ID DESC limit {$offset},{$lenght}";
...
function sharequn(event){
  ...
  $.ajax({
      ...
      success: function (data) {
        ...
        $("#share_qun .modal-body .qrcode").html("<img src='../user/qrcode.php?content="+data.url+"' width='200'/>");
      },
      error : function() {
        // 分享失败
        $("#Result").css("display","block");
