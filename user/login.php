            ...
            <div class="right">
                <div class="form-con">
                    <form onsubmit="return false" id="logincheck">
                        ...
                        <!-- 登陆按钮 -->
                        <button type="submit" class="btn btn-tjzdy" style="width: 100%;" onclick="logincheck();">登陆</button>
                        <!-- 找回密码、注册账号 -->
                        <p class="click"><a href="fpwd.php">找回密码</a>&nbsp;&nbsp;<a href="reg.php">注册账号</a></p>
                    </form>
                </div>
            </div>
        </div>
