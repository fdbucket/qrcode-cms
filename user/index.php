...
<head>
    <title><?php echo $title; ?> - 二维码管理系统</title>
    <meta charset="utf-8">
...
<div class="container">';
  ...
  <div class="left-nav">
    ...
    <a href="./active.php"><button type="button" class="btn btn-zdylight">活动码</button></a>';
        ...
        echo '<a href="./account.php"><button type="button" class="btn btn-zdylight">个人中心</button></a><a href="logout.php"><button type="button" class="btn btn-zdylight">退出登陆</button></a></div>';
        ...
        if ($result->num_rows > 0) {
          ...
          <tbody>';
            ...
            <a class="dropdown-item" href="./edi_qun.php?hmid=' . $qun_hmid . '&home=ediqun">编辑</a>
