    ...
    while($row_wx = $result_wx->fetch_assoc()) {
      ...
      <div class="container">
        ...
        <div class="left-nav">
          ...
          <a href="./wx.php?t=home/ediwx"><button type="button" class="btn btn-zdylight">返回上一页</button></a>
        ...
        <div class="right-nav">
          ...
          <p style="color:#999;font-size:14px;">在线提醒：在工作日和上班时间提醒客服在线，在周日以及下班时间提醒不在线，默认周一至周六为工作日，早上9点上班下午6点下班。如需修改请在get/wx/index.php找到相关代码进行修改。</p>
